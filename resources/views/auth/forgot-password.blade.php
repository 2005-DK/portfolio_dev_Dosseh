...
<head>
    ...
    <title>Forgot Password - Dosseh Admin</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-slate-800/50 backdrop-filter backdrop-blur-md border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
            <div class="text-center mb-8">
                ...
                <p class="text-slate-400">No problem. Just let us know your email address.</p>
            </div>
            ...
            <div class="mt-6 text-center">
                <p class="text-slate-400 text-sm">
                    <a href="{{ route('login') }}" class="text-purple-400 hover:text-purple-300 font-medium">Back to login</a>
                </p>
            </div>
        </div>
    </div>
